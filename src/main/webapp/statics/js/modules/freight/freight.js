$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '商品重量（克）', name: 'productWeight', index: 'product_weight', width: 80 }, 			
			// { label: '商品长度', name: 'productLength', index: 'product_length', width: 80 },
			// { label: '商品宽度', name: 'productWidth', index: 'product_width', width: 80 },
			// { label: '商品高度', name: 'productHeight', index: 'product_height', width: 80 },
			{ label: '运输开始省份', name: 'fromProvince', index: 'from_province', width: 80 },
