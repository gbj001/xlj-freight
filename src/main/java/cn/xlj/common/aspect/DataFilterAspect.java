...
import cn.xlj.modules.sys.service.SysDeptService;
...
public class DataFilterAspect {
    ...
    @Pointcut("@annotation(cn.xlj.common.annotation.DataFilter)")
    ...
    public void dataFilter(JoinPoint point) throws Throwable {
        ...
        throw new RRException("要实现数据运费接口的参数，只能是Map类型，且不能为NULL");
    }
